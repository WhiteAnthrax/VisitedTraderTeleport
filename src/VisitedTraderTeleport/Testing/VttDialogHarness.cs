...
//
// Confirmed against Assembly-CSharp.dll (2026-07-29, 7DTD v2.6 line) by decompiling
...
internal static class VttDialogHarness
{
    ...
    private static void RunDump()
    {
        ...
        json.Append(",\"language\":").Append(Quote(Localization.language));
        json.Append(",\"entries\":[");
    ...
    private static void RunSeed(string countArg)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            destinations.Add(new TraderDestination
            {
                ...
                Position = new Vector3(areaX, 87f, areaZ),
